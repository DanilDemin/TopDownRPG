...
{
	//Create SFML window using options from a window.init file
...
{	
	...
	(
		new MainMenuState
		(
			this->window, &this->supportedKeys, &this->states
		)
	);
...
void Game::updateDt()
{
	/*Updates	the dt variavles with the time
	it takes to update and render one frame*/
